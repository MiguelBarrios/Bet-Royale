		...
		<div class="container">
         ...
         <c:if test="${event.user.id == user.id}">
            <c:if test="${not event.completion}">
               <button type="button" class="btn btn-warning" id="edit" onclick="toggleEventForm()">Edit Event</button>
...
<a id="scrollUp" href="#top" style="position: fixed; z-index: 2147483647; display: block;"><i class="fa fa-angle-double-up"></i></a>
</body>
</html>